%Write a MATLAB program to generate respective windows and
%compute gain plot of rectangular , triangular ,hamming , hanning
%and blackmann windows.
close all
clear all
N=4; %size of x
l=(N-1)/2;
